...
#SBATCH --job-name=preproc-fairseq
...
$PYTHON /gpfs/users/pellegrainv/RNN-Time-series-Anomaly-Detection/1_train_predictor.py --data ../../../workdir/pellegrainv/3Tanks/capteurs_labels_visible --filename 15_epochs --epochs 15
